...
async def book_categories(bot_page: str, categories: list, current_page: int, mode: str = 'book_list'):
	...
	add_category_button = InlineKeyboardButton(text='➕ Добавить жанр', callback_data='add_category')
